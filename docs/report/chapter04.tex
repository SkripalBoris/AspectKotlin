...
\begin{itemize}
	...
	\item \textit{AspectGrammarParser}~--- класс, содержащий в себе парсер
		  сгенерированной грамматики.
	\item \textit{AspectGrammarVisitor}~--- интерфейс, реализующий паттерн проектирования \quotes{посетитель}.
	Содержит список абстрактных методов, используемых для разбора описания.
	\item \textit{AspectGrammarListener}~--- интерфейс, реализующий паттерн проектирования \quotes{слушатель}.
	Содержит список абстрактных методов, используемых для разбора описания.
